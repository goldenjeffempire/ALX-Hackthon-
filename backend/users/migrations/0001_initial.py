    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('employee', 'Employee'), ('team_lead', 'Team Lead'), ('facility_manager', 'Facility Manager'), ('admin', 'Administrator')], default='employee', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_workspace_types', models.JSONField(default=list)),
                ('ergonomic_settings', models.JSONField(blank=True, default=dict)),
